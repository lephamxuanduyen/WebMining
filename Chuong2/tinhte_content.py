...
file_store = 'F:\Web_Mining\Chuong2\crawl_tinhte\content'
url_fileRSS= 'https://tinhte.vn/rss/'
...
def save_toTXT(url):
    ...
    try:
        Title = soup.find('h1',class_='jsx-89440')
        Author = soup.find('div',class_='jsx-89440 author-name')
        Time = soup.find('span',class_='jsx-89440 date')
        Detail = soup.find('article',class_='jsx-89440 content')
